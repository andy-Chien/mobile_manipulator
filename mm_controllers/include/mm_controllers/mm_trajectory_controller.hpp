...
#ifndef MM_CONTROLLERS__MM_TRAJECTORY_CONTROLLER_HPP_
#define MM_CONTROLLERS__MM_TRAJECTORY_CONTROLLER_HPP_
...
#include "mm_controllers/tolerances.hpp"
...
class MMTrajectoryController : public controller_interface::ControllerInterface
{
public:
  MM_CONTROLLERS_PUBLIC
  MMTrajectoryController();
...
protected:
  ...
  mcdd::ArmData arm_data_;
  mcdd::HWInterfaces arm_interfaces_;
  ...
  tf2::Transform map_trans_odom_, map_trans_base_;
...
private:
  ...
  bool updateBaseState(const rclcpp::Time & time, const rclcpp::Duration& period);
};

}  // namespace mm_controllers

#endif  // MM_CONTROLLERS__MM_TRAJECTORY_CONTROLLER_HPP_
